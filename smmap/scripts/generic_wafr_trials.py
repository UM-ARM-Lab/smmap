...
def run_wafr_trials(experiment, run_baseline=False, run_UCB=False, run_KFMANB=False, run_KFRDB=False, optimization_enabled=None, log_prefix=""):
    ...
    if run_baseline:
        ...
        for translational_deform in deform_range:
            for rotational_deform in deform_range:
                run_trial(experiment=experiment,
                          ...
                          test_id=log_prefix + "wafr_paper_trials/" + "single_model_baseline/" + "trans_" + str(translational_deform) + "_rot_" + str(rotational_deform),
                          planning_horizon=1,
        ...
        # run_trial(experiment=experiment,
        #           logging_enabled="true",
        #           test_id=log_prefix + "wafr_paper_trials/" + "single_model_baseline/" + "manually_tuned",
        #           planning_horizon=1,
        #           optimization_enabled=optimization_enabled,
        #           multi_model="false")
        ...
        for adaptive_exponent in adaptive_range:
            ...
            run_trial(experiment=experiment,
                      logging_enabled="true",
                      test_id=log_prefix + "wafr_paper_trials/" + "single_model_baseline/" + "adaptive_1e-" + str(adaptive_exponent),
                      planning_horizon=1,
                      optimization_enabled=optimization_enabled,
                      multi_model="false",
    ...
    if run_UCB:
        run_trial(experiment=experiment,
                  logging_enabled="true",
                  test_id=log_prefix + "wafr_paper_trials/" + "multi_model_UCB_regret",
                  planning_horizon=1,
                  optimization_enabled=optimization_enabled,
    ...
    if run_KFMANB:
        for i in range(0, 10):
            run_trial(experiment=experiment,
                      logging_enabled="true",
                      test_id=log_prefix + "wafr_paper_trials/" + "multi_model_KFMANB_regret_" + str(i),
                      planning_horizon=1,
                      optimization_enabled=optimization_enabled,
    ...
    if run_KFRDB:
        for i in range(0, 10):
            run_trial(experiment=experiment,
                      logging_enabled="true",
                      test_id=log_prefix + "wafr_paper_trials/" + "multi_model_KFRDB_regret_" + str(i),
                      planning_horizon=1,
                      optimization_enabled=optimization_enabled,
