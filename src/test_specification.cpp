...
TestSpecification::TestSpecification(ros::NodeHandle& nh, ros::NodeHandle& ph, const DeformableType deformable_type, const TaskType task_type)
    : TestSpecification(nh, ph, Visualizer(nh, ph), deformable_type, task_type)
{}

TestSpecification::TestSpecification(ros::NodeHandle& nh, ros::NodeHandle& ph, Visualizer vis, const DeformableType deformable_type, const TaskType task_type)
...
TestSpecification::Ptr TestSpecification::MakeTestSpecification(ros::NodeHandle& nh, ros::NodeHandle& ph)
{
    ...
    switch (task_type)
    {
        ...
        case TaskType::ROPE_DRAG_OPPOSITE_TABLE:
            return std::make_shared<RopeTablePullModelTest>(nh, ph);

        case TaskType::ROPE_TOWARD_TABLE:
            return std::make_shared<RopeTowardTableModelTest>(nh, ph);
