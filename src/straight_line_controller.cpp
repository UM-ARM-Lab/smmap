...
StraightLineController::StraightLineController(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<ros::NodeHandle> ph,
...
DeformableController::OutputData StraightLineController::getGripperMotion_impl(const InputData& input_data) {
