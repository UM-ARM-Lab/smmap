...
namespace smmap
{
    ...
    QuinlanRubberBand::QuinlanRubberBand(
        ...
        , min_overlap_distance_(work_space_grid_.minStepDimension() * BAND_MIN_OVERLAP_SCALE_FACTOR)
        , min_distance_to_obstacle_(work_space_grid_.minStepDimension() * BAND_MIN_DIST_TO_OBSTACLES_SCALE_FACTOR)
