...
namespace smmap
{
    ...
    class RopeCylinderCoverageModelTest : public TestSpecification
    {
        public:
            RopeCylinderCoverageModelTest(ros::NodeHandle& nh, ros::NodeHandle& ph)
                : TestSpecification(nh, ph, DeformableType::ROPE, TaskType::ROPE_CYLINDER_COVERAGE)
            {
