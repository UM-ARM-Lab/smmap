...
sdf_tools::CollisionMapGrid ExtractParabolaSliceInPlane(
    const sdf_tools::SignedDistanceField& sdf, const double resolution, const PairGripperPositions& gripper_positions,
    const Eigen::Vector3d& band_midpoint, const double parabola_length,
...
sdf_tools::CollisionMapGrid ExtractParabolaSliceExtendDownwards(
    const sdf_tools::SignedDistanceField& sdf, const double resolution, const PairGripperPositions& gripper_positions,
    const Eigen::Vector3d& band_midpoint, const double parabola_length, const bool gravity_aligned,
    const Visualizer::Ptr vis = nullptr);
