...
class DiminishingRigidityModel final : public JacobianModel {
 public:
  ...
  DiminishingRigidityModel(std::shared_ptr<ros::NodeHandle> nh, const double deformability);

  DiminishingRigidityModel(std::shared_ptr<ros::NodeHandle> nh, const double translation_deformability,
