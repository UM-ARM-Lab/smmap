...
class ClothColabFolding : public TaskSpecification {
 public:
  ClothColabFolding(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<ros::NodeHandle> ph, Visualizer::Ptr vis);
...
class RopeDirectCoverage : public DirectCoverageTask {
 public:
  RopeDirectCoverage(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<ros::NodeHandle> ph, Visualizer::Ptr vis);
...
class ClothDirectCoverage : public DirectCoverageTask {
 public:
  ClothDirectCoverage(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<ros::NodeHandle> ph, Visualizer::Ptr vis);
...
class RopeDistanceBasedCorrespondences : public DistanceBasedCorrespondencesTask {
 public:
  RopeDistanceBasedCorrespondences(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<ros::NodeHandle> ph,
                                   Visualizer::Ptr vis);
...
class ClothDistanceBasedCorrespondences : public DistanceBasedCorrespondencesTask {
 public:
  ClothDistanceBasedCorrespondences(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<ros::NodeHandle> ph,
                                    Visualizer::Ptr vis);
...
class RopeFixedCorrespondences : public FixedCorrespondencesTask {
 public:
  RopeFixedCorrespondences(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<ros::NodeHandle> ph,
                           Visualizer::Ptr vis);
...
class ClothFixedCorrespondences : public FixedCorrespondencesTask {
 public:
  ClothFixedCorrespondences(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<ros::NodeHandle> ph,
                            Visualizer::Ptr vis);
