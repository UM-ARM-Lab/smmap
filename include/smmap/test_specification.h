...
//            static ObjectDeltaAndWeight CalculateObjectErrorCorrectionDeltaWithThreshold();
            ...
            TestSpecification(ros::NodeHandle& nh, ros::NodeHandle& ph, const DeformableType deformable_type, const TaskType task_type);
            TestSpecification(ros::NodeHandle& nh, ros::NodeHandle& ph, Visualizer vis, const DeformableType deformable_type, const TaskType task_type);

            ////////////////////////////////////////////////////////////////////
            // Static builder function
            ////////////////////////////////////////////////////////////////////

            static TestSpecification::Ptr MakeTestSpecification(ros::NodeHandle& nh, ros::NodeHandle& ph);
